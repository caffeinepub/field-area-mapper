...
export class Backend implements backendInterface {
    ...
    async getProjectIds(): Promise<Array<ProjectId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProjectIdsByCreationTime(): Promise<Array<ProjectId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectIdsByCreationTime();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeProject(arg0: ProjectId): Promise<ProjectId> {
        if (this.processError) {
            try {
    ...
    async saveProject(arg0: Project): Promise<ProjectId> {
        if (this.processError) {
            try {
